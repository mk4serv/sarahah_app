export const EmailTemplate = ({message, subject}) => {
                            ...
                            <table cellspacing="0" cellpadding="0" style="margin: auto;">
                                <tr>
                                    <td align="center" style="background-color: #345C72; padding: 10px 20px; border-radius: 5px;">
                                        <a href="${confirmEmailLink}" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold;">Confirm Email</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
